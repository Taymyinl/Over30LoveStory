...
export const chapter15Data: Record<string, Scene> = {
    ...
    'scene_ch15_01_ending_htetnaing': {
        sceneId: 'scene_ch15_01_ending_htetnaing',
        narratorText: ["တစ်နှစ်အကြာ။ သင်နှင့်ထက်နိုင်သည် ဘားတွင်ထိုင်နေကြသည်၊ ဘီယာသောက်ရင်းစကားပြောနေကြသည်။ ဒါပေမဲ့ဒီတစ်ခါတော့မတူတော့ဘူး။ သင်တို့ကမ္ဘာကြီးကိုဖြေရှင်းနေကြတာမဟုတ်ဘူး၊ သင်တို့ရဲ့အနာဂတ်ကိုတည်ဆောက်နေကြတာ။", "သူကသင့်လက်ကိုကိုင်လိုက်သည်။ သူ့ထိတွေ့မှုကရင်းနှီးပြီးနှစ်သိမ့်မှုပေးသည်။ 'ငါတို့မြေပုံကိုတွေ့ပြီထင်တယ်' ဟုသူပြောသည်။ သင်ကခေါင်းညိတ်လိုက်သည်။ သင်တို့အတူတူတွေ့ခဲ့ကြတာ။"],
        playerChoices: [
            { text: "ဇာတ်လမ်းပြီးဆုံးပါပြီ။ (ထက်နိုင်နှင့်အတူ)", nextSceneId: 'scene_wai_yan_epilogue_check', stateUpdates: {keyEvents: ['ending_htetnaing_romance', 'romance_success']} }
        ]
    },
