...
export const chapter9Data: Record<string, Scene> = {
    ...
    'scene_ch9_04_the_disaster_date_intro': {
        ...
        narratorText: [
            "သောကြာနေ့ည။ သင်ကကံဆိုးမိုးမှောင်ကျတဲ့စားသောက်ဆိုင်ကိုရောက်လာသည်။ သင့်သူငယ်ချင်းတွေကစားပွဲကြီးတစ်ခုမှာစောင့်နေကြသည်။ အောင်ရဲမာန်ကမေလေးကိုပါခေါ်လာသည်။ သူမက 'ကျွန်မတောင်းပန်ပါတယ်' ဆိုတဲ့အကြည့်နဲ့သင့်ကိုကြည့်နေသည်။",
    ...
    'scene_ch9_05_the_group_date_talk': {
        ...
        dialogue: [
            ...
            { character: "မေလေး", line: "အောင်ရဲမာန်! တော်တော့!"},
        ...
        playerChoices: [
            ...
            { text: "မျက်နှာကိုလက်နဲ့အုပ်လိုက်သည်။ \"ငါတောင်းပန်ပါတယ်။\"", nextSceneId: 'scene_ch9_06_group_date_end', stateUpdates: {relationshipScores: [{character: 'mayLay', change: 1}]} }
        ]
    },
