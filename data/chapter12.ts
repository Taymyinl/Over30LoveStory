...
export const chapter12Data: Record<string, Scene> = {
    ...
    'scene_ch12_01_fork_in_the_road': {
        ...
        internalMonologue: "ကံကြမ္မာကငါ့ကိုရယ်နေတာပဲ။ ငါ့မှာရွေးချယ်စရာတစ်ခုရှိတယ်- နောက်ဆုံးတော့တကယ့်ဒိတ်တစ်ခုဖြစ်နိုင်ခြေနဲ့ ငါ့ရဲ့အသုံးမကျပေမယ့်သစ္စာရှိတဲ့သူငယ်ချင်းတွေ။ ဒါမှမဟုတ်... တတိယရွေးချယ်စရာတစ်ခုရှိသေးလား?",
        playerChoices: [
            { 
            ...
            { 
                text: "ဒီဒရာမာတွေအားလုံးငါမခံစားနိုင်တော့ဘူး။ ထက်နိုင်နဲ့အေးဆေးညနေခင်းတစ်ခုလောက်ပဲကုန်ဆုံးလိုက်မယ်။", 
                nextSceneId: 'scene_ch13_01_htetnaing_path_intro',
                stateUpdates: { keyEvents: ['chose_htetnaing_over_date'] }
            }
        ]
    },
